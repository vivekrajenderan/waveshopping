...
<form method="post" action="<?php echo base_url() . 'dashboard/add_report'; ?>">
    <table id="addaccount" class="subgrid" style="margin-bottom: 10px;">
        ...
        <tbody>
            <tr>
                <td>
                    <a href='javascript:void(0);'  class='removeItem'><span style="margin: auto 10px;padding: 2px;" class='glyphicon glyphicon-remove'></span></a>                    
                </td>
                <td>
                ...
                <td>
                    <select class="purchaseShop" name="purchased_shop[]">
                ...
                <td>
                    <input class="soldcollected" type="text" name="sold_price[]" value="" maxlength="10">
                </td>
                <td>
                    <input class="purchasecollected" type="text" name="purchase_price[]" value="" maxlength="10">
                </td>
                <td>
                    <input class="deliverycostcollected" type="text" name="deliver_cost[]" value="" maxlength="10">
                </td>
                <td>
                    <select name="deliver_pickup[]" class="deliverPickup">
                ...
                <td>
                    <select name="payment_mode[]" class="paymentMode">
                ...
                <td>
                    <input class="cashreceivedcollected" type="text" name="cash_received[]" value="" maxlength="10">
                </td>
                <td>
                    <select name="status[]">
        ...
        <tfoot>
            <tr>
                <td colspan="6"><a title="Add More" class="AddRow" style="font-size:18px;" href="javascript:void(0);"><span style="margin: auto 10px;padding: 2px;" class="glyphicon glyphicon-plus"></span></a></td>
    ...
    <div style="padding-left: 20px;">
      <input name="addaccount" id="AddAccount" type="button" value="Add a New" class="btn btn-tertiary"  /> &nbsp;&nbsp;<a href="" class="btn btn-tertiary" target="_blank">Add an Extra Expense</a>  
    </div>
